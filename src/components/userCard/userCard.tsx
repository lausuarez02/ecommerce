...
const UserCard = ({email='notMail', name='notName', photo}:userData) => {
  ...
  console.log(photo, 'testing photo value')
    return(
      ...
      <div className="flex w-full transform text-left text-base transition md:my-8 md:max-w-2xl md:px-4 lg:max-w-4xl">
          <div className="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
            <div className="aspect-h-3 aspect-w-2 overflow-hidden rounded-full ring-2 ring-white bg-gray-100 sm:col-span-4 lg:col-span-5">
              {
                !imgError ? (
                <img src={photo} onError={handleImageError} alt="Two each of gray, white, and black shirts arranged on table." className="object-cover object-center"/>
                ) : (
                  <img src={errorImage} alt="Two each of gray, white, and black shirts arranged on table." className="object-cover object-center"/>
                  )
              }
            </div>
